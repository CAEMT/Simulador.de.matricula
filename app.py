...
matrizes = {
    ...
    "2016": {
        "1º Período": {
            'EMT101': {'nome': 'Introdução à Engenharia de Materiais', 'req': [], 'correq': [], 'oferta': 'impar'},
            'CCO001': {'nome': 'Algoritmos e Programação de Computadores', 'req': [], 'correq': [], 'oferta': 'regular'},
            'HD0101': {'nome': 'Ciências Sociais e Humanas', 'req': [], 'correq': [], 'oferta': 'regular'},
            'MAT001': {'nome': 'Cálculo I', 'req': [], 'correq': [], 'oferta': 'regular'},
            'QUI001': {'nome': 'Química Geral', 'req': [], 'correq': [], 'oferta': 'regular'},
            'DES001': {'nome': 'Desenho Técnico Instrumentado', 'req': [], 'correq': [], 'oferta': 'impar'}
        },
        "2º Período": {
            'EMT001': {'nome': 'Ciência dos Materiais I', 'req': ['EMT101', 'QUI001'], 'correq': [], 'oferta': 'par'},
            'FIS001': {'nome': 'Física I', 'req': ['MAT001'], 'correq': [], 'oferta': 'regular'},
            'MAT002': {'nome': 'Cálculo II', 'req': ['MAT001'], 'correq': [], 'oferta': 'regular'},
            'MAT004': {'nome': 'Geometria Analítica e Álgebra Linear', 'req': [], 'correq': [], 'oferta': 'regular'},
            'QUI002': {'nome': 'Química Experimental', 'req': ['QUI001'], 'correq': [], 'oferta': 'regular'}
        },
        "3º Período": {
            'EMT002': {'nome': 'Ciência dos Materiais II', 'req': ['EMT001'], 'correq': [], 'oferta': 'impar'},
            'FIS002': {'nome': 'Física II', 'req': ['FIS001', 'MAT002'], 'correq': [], 'oferta': 'regular'},
            'EME001': {'nome': 'Mecânica Geral', 'req': ['FIS001', 'MAT002'], 'correq': [], 'oferta': 'regular'},
            'MAT003': {'nome': 'Cálculo III', 'req': ['MAT002'], 'correq': [], 'oferta': 'regular'},
            'QUI003': {'nome': 'Físico-Química', 'req': ['QUI001', 'MAT001'], 'correq': [], 'oferta': 'impar'}
        },
        "4º Período": {
            'EMT003': {'nome': 'Termodinâmica dos Materiais', 'req': ['QUI003'], 'correq': [], 'oferta': 'par'},
            'FIS003': {'nome': 'Física III', 'req': ['FIS002', 'MAT003'], 'correq': [], 'oferta': 'regular'},
            'EME002': {'nome': 'Resistência dos Materiais', 'req': ['EME001'], 'correq': [], 'oferta': 'regular'},
            'MAT005': {'nome': 'Cálculo Numérico', 'req': ['MAT002', 'CCO001'], 'correq': [], 'oferta': 'regular'},
            'MAT006': {'nome': 'Estatística e Probabilidade', 'req': ['MAT002'], 'correq': [], 'oferta': 'regular'}
        },
        "5º Período": {
            'EMT004': {'nome': 'Materiais Cerâmicos I', 'req': ['EMT002', 'EMT003'], 'correq': [], 'oferta': 'impar'},
            'EMT005': {'nome': 'Metalurgia Física I', 'req': ['EMT002', 'EMT003'], 'correq': [], 'oferta': 'impar'},
            'IEM001': {'nome': 'Fenômenos de Transporte', 'req': ['MAT003'], 'correq': [], 'oferta': 'impar'},
            'EMT006': {'nome': 'Introdução aos Polímeros', 'req': ['EMT002'], 'correq': [], 'oferta': 'impar'}
        },
        "6º Período": {
            'EMT007': {'nome': 'Processamento de Cerâmicas I', 'req': ['EMT004'], 'correq': [], 'oferta': 'par'},
            'EMT008': {'nome': 'Transformação de Fases', 'req': ['EMT003'], 'correq': [], 'oferta': 'par'},
            'EMT009': {'nome': 'Comportamento Mecânico de Materiais', 'req': ['EME002', 'EMT002'], 'correq': [], 'oferta': 'par'},
            'EMT010': {'nome': 'Estrutura e Propriedades de Polímeros', 'req': ['EMT006'], 'correq': [], 'oferta': 'par'}
        },
        "7º Período": {
            'EMT011': {'nome': 'Técnicas de Caracterização de Materiais', 'req': ['EMT005'], 'correq': [], 'oferta': 'impar'},
            'EMT012': {'nome': 'Corrosão e Proteção de Materiais', 'req': ['EMT003'], 'correq': [], 'oferta': 'impar'},
            'EEB001': {'nome': 'Eletrotécnica Geral', 'req': ['FIS003'], 'correq': [], 'oferta': 'regular'},
            'EMT013': {'nome': 'Materiais Compósitos', 'req': ['EMT002'], 'correq': [], 'oferta': 'impar'}
        },
        "8º Período": {
            'EMT014': {'nome': 'Seleção de Materiais', 'req': ['EMT009'], 'correq': [], 'oferta': 'par'},
            'EP0001': {'nome': 'Higiene e Segurança do Trabalho', 'req': [], 'correq': [], 'oferta': 'regular'},
            'EMT015': {'nome': 'Processamento de Polímeros', 'req': ['EMT010'], 'correq': [], 'oferta': 'par'}
        },
        "9º Período": {
            'IEPG01': {'nome': 'Administração e Economia', 'req': [], 'correq': [], 'oferta': 'impar'},
            'TCC001': {'nome': 'Trabalho de Conclusão de Curso I', 'req': [], 'correq': [], 'oferta': 'regular'}
        },
        "10º Período": {
            'EST001': {'nome': 'Estágio Supervisionado', 'req': [], 'correq': [], 'oferta': 'regular'},
            'TCC002': {'nome': 'Trabalho de Conclusão de Curso II', 'req': ['TCC001'], 'correq': [], 'oferta': 'regular'}
        }
    }
}
...
with col_direita:
    ...
    for semestre, materias in grade_selecionada.items():
        for codigo, dados in materias.items():
            ...
            if tem_requisitos:
                ...
                if oferta_bate:
                    # Uso do .get() previne quebra caso a grade selecionada não defina correquisitos
    ...
    if not liberadas_regulares and not liberadas_nao_ofertadas and not liberadas_com_aviso_correq:
        ...
        # Disciplinas com aviso de correquisito (Laranjas)
        ...
        # Disciplinas não ofertadas (Vermelhas)
