...
/* ==========================================================
   WIDGETS NATIVOS - FORÇAR APARÊNCIA CLARA
   ========================================================== */
...
/* Checkbox marcado: mantém o roxo da identidade */
...
/* ==========================================================
   CAMADA FINAL - FUNDO BRANCO INDEPENDENTE DA VERSÃO
   DO STREAMLIT / BASEWEB
   ========================================================== */

/* Selectbox: pinta todas as camadas do campo de branco. */
[data-testid="stSelectbox"],
[data-testid="stSelectbox"] > div,
...
/* Dropdown do selectbox, inclusive quando é montado fora da árvore principal. */
...
/* Botões: o botão é branco e seus elementos internos ficam transparentes. */
[data-testid="stButton"] button,
.stButton button,
button[kind="secondary"],
...
/* Expander: remove fundos herdados do tema escuro em qualquer camada. */
[data-testid="stExpander"],
[data-testid="stExpander"] details,
...
/* Checkbox: não deixa o quadrado desmarcado herdar preto. */
[data-testid="stCheckbox"] label,
[data-testid="stCheckbox"] label[data-baseweb="checkbox"] {
    color-scheme: light !important;
    background: transparent !important;
...
/* Campos BaseWeb genéricos usados por versões novas do Streamlit. */
...
/* Containers que o Streamlit cria em torno dos widgets. */
...
/* ==========================================================
   AJUSTE FINAL - PEQUENOS BLOCOS ESCUROS
   Corrige especificamente:
   1) a área da seta à direita do selectbox;
   2) o quadrado dos checkboxes desmarcados.
   ========================================================== */

/* SELECTBOX: o campo inteiro fica branco e os filhos não podem
   desenhar um bloco escuro por cima. */
[data-testid="stSelectbox"] [data-baseweb="select"] > div {
    background: #FFFFFF !important;
    background-color: #FFFFFF !important;
    border-color: var(--border-color) !important;
...
[data-testid="stSelectbox"] [data-baseweb="select"] > div > *,
[data-testid="stSelectbox"] [data-baseweb="select"] > div > * > *,
[data-testid="stSelectbox"] [data-baseweb="select"] button,
[data-testid="stSelectbox"] [data-baseweb="select"] [role="button"] {
    background: transparent !important;
    background-color: transparent !important;
}

/* Área específica do indicador/seta, que em algumas versões do
   BaseWeb recebe uma cor escura própria. */
[data-testid="stSelectbox"] [data-baseweb="select"] > div > div:last-child,
[data-testid="stSelectbox"] [data-baseweb="select"] > div > div:last-child > div,
[data-testid="stSelectbox"] [data-baseweb="select"] > div > span:last-child,
[data-testid="stSelectbox"] [data-baseweb="select"] > div > button:last-child {
    background: #FFFFFF !important;
    background-color: #FFFFFF !important;
    color: var(--text-color) !important;
}
...
[data-testid="stSelectbox"] [data-baseweb="select"] > div > div:last-child::before,
[data-testid="stSelectbox"] [data-baseweb="select"] > div > div:last-child::after {
    background: transparent !important;
    background-color: transparent !important;
}
...
/* CHECKBOX DESMARCADO: cobre as diferentes estruturas usadas pelo
   Streamlit/BaseWeb e também possíveis pseudo-elementos. */
[data-testid="stCheckbox"] label[data-baseweb="checkbox"]:has(input:not(:checked)) > span:first-child,
[data-testid="stCheckbox"] label[data-baseweb="checkbox"]:has(input:not(:checked)) > span:first-child > *,
[data-testid="stCheckbox"] label[data-baseweb="checkbox"]:has(input:not(:checked)) > div:first-child,
[data-testid="stCheckbox"] label[data-baseweb="checkbox"]:has(input:not(:checked)) > div:first-child > *,
[data-testid="stCheckbox"] label[data-baseweb="checkbox"] input:not(:checked) + div,
[data-testid="stCheckbox"] label[data-baseweb="checkbox"] input:not(:checked) + span,
[data-testid="stCheckbox"] label[data-baseweb="checkbox"] input:not(:checked) ~ div:first-of-type,
...
[data-testid="stCheckbox"] label[data-baseweb="checkbox"]:has(input:not(:checked)) > span:first-child::before,
[data-testid="stCheckbox"] label[data-baseweb="checkbox"]:has(input:not(:checked)) > span:first-child::after,
[data-testid="stCheckbox"] label[data-baseweb="checkbox"]:has(input:not(:checked)) > div:first-child::before,
[data-testid="stCheckbox"] label[data-baseweb="checkbox"]:has(input:not(:checked)) > div:first-child::after {
    background: #FFFFFF !important;
    background-color: #FFFFFF !important;
}

/* Mantém o estado marcado em roxo. */
[data-testid="stCheckbox"] label[data-baseweb="checkbox"]:has(input:checked) > span:first-child,
[data-testid="stCheckbox"] label[data-baseweb="checkbox"]:has(input:checked) > span:first-child > *,
[data-testid="stCheckbox"] label[data-baseweb="checkbox"]:has(input:checked) > div:first-child,
[data-testid="stCheckbox"] label[data-baseweb="checkbox"]:has(input:checked) > div:first-child > *,
[data-testid="stCheckbox"] label[data-baseweb="checkbox"] input:checked + div,
[data-testid="stCheckbox"] label[data-baseweb="checkbox"] input:checked + span,
